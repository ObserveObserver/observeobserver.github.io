...
<html>
<head>
<title>i - *observe.observer</title>
...
<h1 id="storytitle">i</h1>

<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script><script src="f/typeWriter.js"></script>
...
i want to make everyone happy.</p></div>
</body>
</html>
